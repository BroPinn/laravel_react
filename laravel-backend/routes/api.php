...
// Public routes
Route::get('products', [ProductController::class, 'index']); // Public access to products
Route::get('products/{id}', [ProductController::class, 'show']); // Public access to single product
